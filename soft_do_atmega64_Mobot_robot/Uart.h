...
/**
   ...
   @return  none
w³¹cza modu³ UART i ustawia prêdkoœæ transmisji,
*/
 ...
 *  @return  none
 umieszcza ci¹g znaków do wys³ania w buforze cyklicznym,
 */
 ...
 * @return   none
 * @see      uart_puts_P
 umieszcza ci¹g znaków (z pamiêci programu) do wys³ania w buforze cyklicznym,
 */
...
/** @brief   zwraca iloœæ bajtów w otrzymanym buforze */
extern int uart_available(void);

/** @brief  Sp³ukaj bajty czekaj¹ce w otrzymanym buforze */
extern void uart_flush(void);

/** w³¹cza drugi modu³ UART i ustawia prêdkoœæ transmisji (tylko wybrane uk³ady ATMega), */
...
/** umieszcza ci¹g znaków do wys³ania w buforze cyklicznym (drugi modu³ - tylko wybrane uk³ady ATMega), */
extern void uart1_puts(const char *s,unsigned int ile  );
/* umieszcza ci¹g znaków (z pamiêci programu) do wys³ania w buforze cyklicznym  (drugi modu³ - tylko wybrane uk³ady ATMega). */
