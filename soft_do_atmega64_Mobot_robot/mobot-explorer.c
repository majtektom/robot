...
//	UART0_print("UART0 test\r\n");
	...
	{ 
		...
		if(I2C_BUF_status.st_ready){//mamy dane do odczytania
			...
			for(int i=0;i<ile;i++){
			  switch(I2C_Buf[i]){
				case 0x10://predko�ci silnik�w	po nim s� 2 bajty pr�dko�ci lewego i prawego silnika
					i++;
					...
					break;
				case 0x11://�adanie podania pr�d�w silnik�w
					...
					break;
				case 0x12://�adanie podania napi�cia
					//I2C_Buf[0] pomijamy bo biblioteka na rasberypi wysy�a 1 bajt w czasie odczytu danych i nadpisuje nam pierwszy bajt
				...
				case 0x13://�adanie podania pradu serw
					...
					break;
				case 0x20://�adanie ustawienia progu alarmu pradowego nastepna dana to pr�g
					i++;
					g_info.prog_alarmu_pradu=I2C_Buf[i];
					break;
				case 0x21://�adanie ustawienia progu alarmu pradowego nastepna dana to pr�g. 2 bajty
					i++;
			...
			I2C_BUFEmpty();//resetujemy bufor i zezwalamy na nast�pny odbi�r/zapis danych
		}
